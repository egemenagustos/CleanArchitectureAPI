...
namespace CleanArchitecture.Persistance.Migrations
{
    ...
    [Migration("20240323081534_initial-create")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CleanArchitecture.Domain.Entities.Fuel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("CleanArchitecture.Domain.Entities.Model", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("CleanArchitecture.Domain.Entities.Transmission", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("CleanArchitecture.Domain.Entities.Car", b =>
                {
                    b.HasOne("CleanArchitecture.Domain.Entities.Model", "Model")
                        .WithMany("Cars")
            ...
            modelBuilder.Entity("CleanArchitecture.Domain.Entities.Model", b =>
                {
                    ...
                    b.HasOne("CleanArchitecture.Domain.Entities.Fuel", "Fuel")
                        .WithMany("Models")
                        .HasForeignKey("FuelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CleanArchitecture.Domain.Entities.Transmission", "Transmission")
                        .WithMany("Models")
